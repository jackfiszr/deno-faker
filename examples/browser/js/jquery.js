...
!function(e, t) {
  ...
  function C(e) {
    ...
    return !g(e) && !y(e) &&
      ("array" === n || 0 === t || "number" == typeof t && t > 0 &&
        t - 1 in e);
  }
  var E = function(e) {
    ...
    function oe(e, t, r, i) {
      var o, s, l, c, f, h, v, m = t && t.ownerDocument, T = t
        ? t.nodeType
        : 9;
      if (
        r = r || [],
      ...
      if (
        !i && ((t ? t.ownerDocument || t : w) !== d && p(t), t = t || d, g)
      ) {
        if (11 !== T && (f = J.exec(e))) {
          if (o = f[1]) {
            if (9 === T) {
            ...
            if (
              (o = f[3]) && n.getElementsByClassName &&
        ...
        return a !== d && 9 === a.nodeType && a.documentElement
          ? (d = a,
            ...
            r.find.CLASS = n.getElementsByClassName && function(e, t) {
              if (
                "undefined" != typeof t.getElementsByClassName && g
              ) {
      ...
      oe.matchesSelector = function(e, t) {
        if (
          ...
          try {
            var r = m.call(e, t);
            if (
              r || n.disconnectedMatch || e.document &&
          ...
          return 1 === r && 0 === i
            ...
            : function(t, n, u) {
              var l, c, f, p, d, h, g = o !== a
                ? "nextSibling"
                : "previousSibling", y = t.parentNode,
      ...
      return r && !r[b] && (r = Te(r)),
        ...
        se(function(o, a, s, u) {
          var l, c, f, p = [], d = [], h = a.length,
            g = o || be(t || "*", s.nodeType ? [s] : s, []), y = !e || !o && t
              ? g
              : we(g, p, e, s, u), v = n ? i || (o ? e : h || r) ? [] : a : y;
          if (n && n(y, v, s, u), r) {
            l = we(v, d),
              r(l, [], s, u),
              c = l.length;
    ...
    function Ce(e) {
      for (
        var t, n, i, o = e.length, a = r.relative[e[0].type],
          s = a || r.relative[" "], u = a ? 1 : 0, c = me(function(e) {
            return e === t;
          }, s, !0), f = me(function(e) {
            return O(t, e) > -1;
          }, s, !0), p = [function(e, n, r) {
            var i = !a && (r || n !== l) || ((t = n).nodeType
              ? c(e, n, r)
              : f(e, n, r));
            return t = null, i;
          }];
  ...
  w.extend({ Deferred: function(t) {
    ...
    if (
      t <= 1 && ($(e, a.done(s(n)).resolve, a.reject, !t),
  ...
  w.extend({ hasData: function(e) {
    ...
    w.extend({ queue: function(e, t, n) {
      ...
      var n = t + "queueHooks";
      return J.get(e, n) ||
        J.access(e, n, { empty: w.Callbacks("once memory").add(function() {
  ...
  function fe(e, t) {
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++) {
      (r = e[o]).style && (n = r.style.display,
        t
          ? ("none" === n && (i[o] = J.get(r, "display") || null,
            i[o] || (r.style.display = "")),
  ...
  function xe(e, t, n, r, i) {
    for (
      var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0,
        h = e.length;
      d < h;
      d++
    ) {
  ...
  w.event = { global: {}, add: function(e, t, n, r, i) {
    ...
    Object.defineProperty(
      w.Event.prototype,
      e,
      { enumerable: !0, configurable: !0, get: g(t)
        ? function() {
  ...
  function Re(e, t, n, r) {
    ...
    if (
      v || p > 1 && "string" == typeof y && !h.checkClone && je.test(y)
    ) {
    ...
    if (
      p && (i = xe(t, e[0].ownerDocument, !1, e, r),
        o = i.firstChild,
  ...
  !function() {
    ...
    c.style && (c.style.backgroundClip = "content-box",
      ...
      w.extend(h, { boxSizingReliable: function() {
        return t(), o;
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        "string" == (o = typeof n) && (i = ie.exec(n)) && i[1] &&
          (n = ue(e, t, i), o = "number"),
          null != n && n === n &&
            ("number" === o && (n += i && i[3] || (w.cssNumber[s]
              ? ""
              : "px")),
  ...
  w.Tween = tt,
    tt.prototype = { constructor: tt, init: function(e, t, n, r, i, o) {
      this.elem = e,
        this.prop = n,
    ...
    tt.propHooks = { _default: { get: function(e) {
      var t;
      ...
      w.fx.step[e.prop]
        ? w.fx.step[e.prop](e)
        : 1 !== e.elem.nodeType || null == e.elem.style[w.cssProps[e.prop]] &&
          !w.cssHooks[e.prop]
          ? e.elem[e.prop] = e.now
  ...
  function lt(e, t, n) {
    for (
      var r, i = (pt.tweeners[t] || []).concat(pt.tweeners["*"]), o = 0,
        a = i.length;
      o < a;
      o++
    ) {
  ...
  function pt(e, t, n) {
    var r, i, o = 0, a = pt.prefilters.length,
      s = w.Deferred().always(function() {
        ...
        if (i) return !1;
        for (
          var t = nt || st(), n = Math.max(0, l.startTime + l.duration - t),
    ...
    w.extend({ attr: function(e, t, n) {
      ...
      if (
        ...
        return "undefined" == typeof e.getAttribute
          ? w.prop(e, t, n)
          : (1 === o && w.isXMLDoc(e) ||
            (i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t)
              ? dt
              : void 0)),
            void 0 !== n
              ? null === n
  ...
  w.fn.extend({ prop: function(e, t) {
    ...
    h.optSelected || (w.propHooks.selected = { get: function(e) {
      var t = e.parentNode;
  ...
  w.fn.extend({ addClass: function(e) {
    ...
    while (n = this[r++]) {
      if (
        1 === n.nodeType && (" " + vt(mt(n)) + " ").indexOf(t) > -1
      ) {
        return !0;
      }
    }
  ...
  w.fn.extend({ val: function(e) {
    var t, n, r, i = this[0];
    {
      ...
      if (
        ...
        return (t = w.valHooks[i.type] ||
          w.valHooks[i.nodeName.toLowerCase()]) && "get" in t &&
    ...
    w.extend({ valHooks: { option: { get: function(e) {
      ...
      var t, n, r, i = e.options, o = e.selectedIndex,
        a = "select-one" === e.type, s = a ? null : [], u = a
          ? o + 1
          : i.length;
  ...
  w.extend(w.event, { trigger: function(t, n, i, o) {
    var a, s, u, l, c, p, d, h, v = [i || r], m = f.call(t, "type")
      ? t.type
      : t, x = f.call(t, "namespace")
        ? t.namespace.split(".")
        : [];
    if (
      s = h = u = i = i || r,
      ...
      return t.type = m,
        o || t.isDefaultPrevented() || d._default &&
          !1 !== d._default.apply(v.pop(), n) || !Y(i) || c && g(i[m]) &&
          !y(i) && ((u = i[c]) && (i[c] = null),
            w.event.triggered = m,
  ...
  w.extend(
    {
      ...
      ajax: function(t, n) {
        ...
        var i, o, a, s, u, l, c, f, p, d, h = w.ajaxSetup({}, n),
          g = h.context || h, y = h.context && (g.nodeType || g.jquery)
            ? w(g)
            : w.event, v = w.Deferred(), m = w.Callbacks("once memory"),
      ...
      if (h.cors || Gt && !t.crossDomain) {
        return { send: function(i, o) {
          ...
          n = function(e) {
            return function() {
              n &&
                (n = r = s.onload = s.onerror = s.onabort = s.ontimeout = s
  ...
  w.ajaxSetup({ jsonp: "callback", jsonpCallback: function() {
    ...
    w.ajaxPrefilter("json jsonp", function(t, n, r) {
      var i, o, a, s = !1 !== t.jsonp && (Qt.test(t.url)
        ? "url"
        : "string" == typeof t.data && 0 === (t.contentType || "").indexOf(
          "application/x-www-form-urlencoded"
        ) && Qt.test(t.data) && "data");
      if (
        s || "jsonp" === t.dataTypes[0]
      ) {
